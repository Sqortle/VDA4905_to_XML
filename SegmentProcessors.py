...
class BaseSegmentProcessor:
    ...
    def get_schedule_info(self, date_value):
        ...
        try:
            ...
            # Herhangi bir tarih hesaplama hatasında varsayılan değerler
            pass
...
class Segment511Processor(BaseSegmentProcessor, ISegmentProcessor):
    def process(self, segment: str, context: ConversionContext):
        try:
            ...
            print(f"Error: Segment 511 is too short or malformed: {segment}")
        except Exception as e:
            print(f"Error processing segment 511: {e}")
...
class Segment512Processor(BaseSegmentProcessor, ISegmentProcessor):
    def process(self, segment: str, context: ConversionContext):
        try:
            ...
            print(f"Error: Segment 512 is too short or malformed: {segment}")
        except Exception as e:
            print(f"Error processing segment 512: {e}")
...
class Segment513Processor(BaseSegmentProcessor, ISegmentProcessor):
    def process(self, segment: str, context: ConversionContext):
        try:
            ...
            print(f"Error: Segment 513 is too short or malformed: {segment}")
        except Exception as e:
            print(f"Error processing segment 513: {e}")
    ...
    def process_demand_fields(self, segment, context, start_index, end_index):
        ...
        try:
            ...
            print(f"Error processing 513 demand fields for segment {segment}: {e}")

        context.last_delivery_date = last_processed_date

    def functionScheduleLineHeaders(self, demand_lines_el, current_article_line, schedule_no_str, delivery_date,
                                    line_type_id, qty_field, customer_po_no, dock_code):
        try:
            ...
            print(f"Error creating schedule line XML: {e}")
...
class Segment514Processor(Segment513Processor, ISegmentProcessor):
    def process(self, segment: str, context: ConversionContext):
        try:
            ...
            print(f"Error: Segment 514 is too short or malformed: {segment}")
        except Exception as e:
            print(f"Error processing segment 514: {e}")